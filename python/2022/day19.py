...
def part1(input_str: str) -> str:
    blueprints = input_str.strip().splitlines()
    blueprints = list(map(Blueprint, blueprints))
    quality_level = multiprocess_quality_levels(blueprints)
...
def part2(input_str: str) -> str:
    blueprints = input_str.strip().splitlines()
    blueprints = list(map(Blueprint, blueprints))
    geode_product = multiprocess_max_geodes(blueprints[:3])
    return str(geode_product)
